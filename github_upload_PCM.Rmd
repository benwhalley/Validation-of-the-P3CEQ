This script performs cleans the entered dataset and conducts Rasch analysis and reliability testing of the P3CEQ
...
```{r}
raw_data <- read.csv("file path goes here")
...
Might be interesting to look at model fit:
```{r}
...
And this would enable you to recreate the ICC plots, but you can also identify the cut/transition points in terms of probilities by summarising:
...
I think this is a useful plot to show where on the latent each question is adding information
